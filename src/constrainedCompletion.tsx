...
function injectStyles() {
  ...
  style.textContent = `
    ...
    .constraint-header-copy {
      display: grid;
      gap: 4px;
    }

    .constraint-header-copy b {
      font-size: 18px;
    }
...
function runConstraint(
  ...
  window.ARBORENUM_CONSTRAINED_COMPLETION_RESULT = undefined;
  window.ARBORENUM_CONSTRAINED_COMPLETION = spec;

  optimal.click();

  window.ARBORENUM_CONSTRAINED_COMPLETION = undefined;

  const result = window.ARBORENUM_CONSTRAINED_COMPLETION_RESULT;
